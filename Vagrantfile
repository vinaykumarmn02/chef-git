...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "vin1234-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/vin123"
  #   chef.validation_client_name = "vin123-validator"
  #   chef.validation_key_path = ".chef/vin123-validator.pem"
  # end
end
